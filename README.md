...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-z71u8si.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-z71u8si.containers.anotherwebservice.com/
...
```
git clone git@github.com:aiproductmanager/ai.git
cd container-z71u8si
```
...
```
docker attach container-z71u8si
```
